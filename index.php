...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientCompany'] = "w0v5UVBNmeyrPOFlQfLv";
        $headers['auth']['clientSecret'] = "MzYyNHcwdjVVVkJObWV5clBPRmxRZkx2Y2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
